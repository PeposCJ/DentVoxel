...
const messages = {
  en: {
    ...
    viewerTools: 'Viewer tools', crosshairs: 'Crosshairs', windowLevel: 'Window/level', pan: 'Pan', zoom: 'Zoom', length: 'Measure', deleteMeasurement: 'Delete selected', autoLayout: 'Auto layout', reset: 'Reset', fullscreen: 'Fullscreen',
    minimizeView: 'Minimize {{view}}', restoreView: 'Restore {{view}}', minimizedViews: 'Minimized views', resizeColumns: 'Resize view columns', resizeRows: 'Resize view rows',
    views: 'Views', selectViews: 'Choose visible views', viewOpen: 'Open', viewClosed: 'Closed',
    ...
    folderSummary: 'Folder classification summary', filesExamined: 'Files examined', dicomIndexed: 'DICOM indexed', usableSlices: 'Usable slices', filesSeparated: 'Separated',
    classificationSummary: '{{volumes}} volume series · {{localizers}} localizers · {{incompatible}} incompatible series',
    ...
    viewerHelp: 'Wheel: browse slices · Drag: active tool', measurementHelp: 'Drag to measure in mm · Select and press Delete to remove · Verify clinically', selectedSlices: '{{count}} selected slices', filesProgress: '{{current}} of {{total}} files',
    readingFilesProgress: 'Reading DICOM headers · {{current}} of {{total}} files', classifyingSeries: 'Classifying studies and series…',
    initializingViewer: 'Initializing the local imaging engine…', registeringSlices: 'Registering the selected slices…', buildingVolume: 'Building the spatial volume…',
    decodingPixels: 'Decoding pixels on this device…', decodingPixelsProgress: 'Decoding pixels · {{current}} of {{total}}', renderingViews: 'Rendering MPR and 3D views…',
    ...
    pixelDecodeFailed: '{{failed}} of {{total}} slices could not be decoded. The transfer syntax or pixel data may not be supported.',
    ...
    unsupportedSyntaxReason: 'Unsupported transfer syntax: {{syntax}}', missingTransferSyntaxReason: 'The DICOM transfer syntax is not declared', modalityReason: '{{modality}} modality is not compatible with dental CBCT volumes',
    ...
    reducedPreviewReason: 'Adaptive {{factor}}× reduction · approximately {{voxels}} million voxels',
    openReducedPreview: 'Open reduced preview', selectedReducedPreview: '{{count}} source slices · preparing a {{factor}}× reduced preview',
    reducedPreviewActive: '{{factor}}× reduced preview · not full resolution', reducedPreviewBadge: '{{factor}}× REDUCED PREVIEW',
    reducedPreviewStatus: 'Reduced preview · verify details in the full-resolution source',
  ...
  es: {
    ...
    viewerTools: 'Herramientas del visor', crosshairs: 'Cruceta', windowLevel: 'Contraste', pan: 'Mover', zoom: 'Zoom', length: 'Medir', deleteMeasurement: 'Borrar selección', autoLayout: 'Ajuste auto', reset: 'Recentrar', fullscreen: 'Pantalla',
    minimizeView: 'Minimizar {{view}}', restoreView: 'Restaurar {{view}}', minimizedViews: 'Vistas minimizadas', resizeColumns: 'Ajustar columnas de vistas', resizeRows: 'Ajustar filas de vistas',
    views: 'Vistas', selectViews: 'Elige las vistas visibles', viewOpen: 'Abierta', viewClosed: 'Cerrada',
    ...
    folderSummary: 'Resumen de clasificación de la carpeta', filesExamined: 'Archivos revisados', dicomIndexed: 'DICOM indexados', usableSlices: 'Cortes utilizables', filesSeparated: 'Separados',
    classificationSummary: '{{volumes}} series volumétricas · {{localizers}} localizadores · {{incompatible}} series incompatibles',
    ...
    viewerHelp: 'Rueda: navegar cortes · Arrastrar: herramienta activa', measurementHelp: 'Arrastra para medir en mm · Selecciona y pulsa Supr para borrar · Verifica clínicamente', selectedSlices: '{{count}} cortes seleccionados', filesProgress: '{{current}} de {{total}} archivos',
    readingFilesProgress: 'Leyendo cabeceras DICOM · {{current}} de {{total}} archivos', classifyingSeries: 'Clasificando estudios y series…',
    initializingViewer: 'Iniciando el motor de imagen local…', registeringSlices: 'Registrando los cortes seleccionados…', buildingVolume: 'Construyendo el volumen espacial…',
    decodingPixels: 'Decodificando píxeles en este dispositivo…', decodingPixelsProgress: 'Decodificando píxeles · {{current}} de {{total}}', renderingViews: 'Renderizando vistas MPR y 3D…',
    ...
    pixelDecodeFailed: 'No fue posible decodificar {{failed}} de {{total}} cortes. La sintaxis de transferencia o los datos de píxel podrían no ser compatibles.',
    ...
    unsupportedSyntaxReason: 'Sintaxis de transferencia no soportada: {{syntax}}', missingTransferSyntaxReason: 'La sintaxis de transferencia DICOM no está declarada', modalityReason: 'La modalidad {{modality}} no es compatible con volúmenes CBCT dentales',
    ...
    reducedPreviewReason: 'Reducción adaptativa {{factor}}× · aproximadamente {{voxels}} millones de vóxeles',
    openReducedPreview: 'Abrir vista reducida', selectedReducedPreview: '{{count}} cortes originales · preparando vista reducida {{factor}}×',
    reducedPreviewActive: 'Vista reducida {{factor}}× · no es resolución completa', reducedPreviewBadge: 'VISTA REDUCIDA {{factor}}×',
    reducedPreviewStatus: 'Vista reducida · verifica los detalles en la fuente a resolución completa',
