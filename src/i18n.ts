...
const messages = {
  en: {
    ...
    volumeTooLargeReason: 'Volume exceeds the current safe local limit ({{voxels}} million voxels)',
  ...
  es: {
    ...
    volumeTooLargeReason: 'El volumen supera el límite local seguro actual ({{voxels}} millones de vóxeles)',
